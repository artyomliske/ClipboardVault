...
Проект проверен в Xcode 26.6: Release-сборка для arm64 успешно создаётся. Если вы собираете приложение самостоятельно, используйте Xcode и выполняйте запуск через `Cmd + R`.
